...
let hide = null
const baseURLDev = 'https://www.fastmock.site/mock/c9c74c897056ac70d6ecca27966795aa/test'
const instance = axios.create({    //创建axios实例，在这里可以设置请求的默认配置
  timeout: 6000, // 设置超时时间10s
  baseURL: process.env.NODE_ENV === 'development' ? baseURLDev : ''   //根据自己配置的反向代理去设置不同环境的baeUrl
})
